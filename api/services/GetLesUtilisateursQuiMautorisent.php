...
// Dernière mise à jour : 17/11/2020 par alexandreé

// Les paramètres doivent être passés par la méthode GET :
//     http://ws-php-proust/tracegps/api/GetTousLesUtilisateurs?pseudo=callisto&mdp=13e3668bbee30b004380052b086457b014504b3e&lang=xml
...
$code_reponse = 406;
    ...
    {	// récupération de la liste des utilisateurs à l'aide de la méthode getLesUtilisateursAutorises de la classe DAO
        ...
        if ($nbReponses == 0) {
            ...
            $msg = $nbReponses . " autorisation(s) accordées par " . $pseudo;
            $code_reponse = 200;
        }
    }
    }
...
function creerFluxXML($msg, $lesUtilisateurs)
{
    ...
    $elt_commentaire = $doc->createComment('Service web GetLesUtilisateursQueJajoute - BTS SIO - Lycée De La Salle - Rennes');
